...
## Recently done
- **Why? + About consolidated into one /about page (2026-07-13):** mission, the problem, what we do, what makes it different, principles, and "who's behind it" (named-founder Felix Edge-Partington + funding line: independent, takes no money from scored companies, self-funded for now, non-profit once the model is proven; acknowledges a possible paid/licensed version later). Copy went through Felix line-by-line. Also added a **"what the temperature refers to"** explainer (global avg surface warming above pre-industrial, same basis as Paris 1.5/2°C) on both /about and /methodology. Nav order now **Scores · About · Methodology**; old `/why` 307-redirects to `/about`.
